...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className={`
        ...
        z-20 transition-all duration-300 ease-[cubic-bezier(0.25,1,0.5,1)]
    ...
    `}>
        ...
        {isSidebarCollapsed && (
             <div className="flex flex-col items-center gap-4 pt-6">
                <button onClick={resetChat} className="p-3 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-xl shadow-md hover:scale-105 transition-transform">
                    <Plus size={20} />
                </button>
                <button onClick={() => setIsDarkMode(!isDarkMode)} className="p-3 text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl mt-auto mb-6 transition-colors">
            ...
            <>
                ...
                <div className="px-5 pt-5 pb-2 space-y-3 shrink-0">
                    ...
                    <div className="bg-zinc-100 dark:bg-zinc-800/60 p-1 rounded-xl flex relative">
                        {/* Sliding Indicator Background (Simulated with layout for simplicity) */}
                        <button 
